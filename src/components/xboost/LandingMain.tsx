	...
	return (
		<section className="pb bg-white">
			<div className="container-centered">
				...
				<div className="md:flex items-stretch lg:items-center md:mb-10 mb-20">
			...
			<div className="container-centered">
				<div className="md:flex items-center flex-row-reverse">
					<div className="md:w-1/2 flex justify-start md:justify-center items-center relative mt-10" style={imgShowcaseStyleWave1}>
